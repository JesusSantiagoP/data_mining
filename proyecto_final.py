...
def select_features(X2_train, y1_train, X2_test):
	fs = SelectKBest(score_func=mutual_info_regression, k='all')
	fs.fit(X2_train, y1_train)
	X2_train_fs = fs.transform(X2_train)
	X2_test_fs = fs.transform(X2_test)
...
scores = cross_val_score(clf,X_train_new,y_train,cv=kf)
